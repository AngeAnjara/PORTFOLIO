    ...
    <section className="self-stretch flex grow flex-col max-md:max-w-full ">
      ...
      <div className="self-center w-full max-w-[993px] min-h-[80vh]  max-md:max-w-full">
        ...
        <p className="text-black text-base self-center max-w-[1066px] mt-12 max-md:max-w-full max-md:mt-10">
          <span className="mx-4"></span> Mon parcours professionnel s'est
          façonné à travers les lentilles de la créativité, de la conception
          visuelle, du cadrage cinématographique, et enfin, du développement
          web. En tant que photographe, j'ai capturé des moments intemporels,
          développant un sens aigu de la composition et de la narration
          visuelle. Mon œil artistique s'est ensuite étendu à la conception
          graphique, où j'ai traduit mes visions en visuels percutants. <br />{" "}
          <br /> <span className="mx-4"></span> En m'immergeant dans l'univers
          cinématographique en tant que cadreur et monteur, j'ai affiné mes
          compétences narratives, jouant avec la lumière, les mouvements de
          caméra, et les séquences pour créer des histoires visuelles
          captivantes. La transition vers le développement web a été une
          évolution naturelle, où j'ai canalisé ma passion pour la créativité
          dans la construction d'expériences en ligne exceptionnelles.
        </p>
        <div>
          <br />
          <Parcours />
        ...
        <p className="text-black text-base self-center max-w-[1048px] mt-11 max-md:max-w-full max-md:mt-10">
          ...
          d'expérience en tant que photographe, designer, et cadreur-monteur,
          j'ai tissé un parcours créatif unique.
        </p>
        ...
        <p className="text-black text-base self-center max-w-[1052px] mt-11 max-md:max-w-full max-md:mt-10">
          Prêt à explorer de nouvelles opportunités passionnantes et à
          collaborer sur des projets captivants. Rencontrons-nous et créons
